...
export async function generateMetadata({
  ...
  const title = `${caseStudy.company} — ${caseStudy.title} | DON Video`;
  ...
  return {
    ...
    keywords: currentLang === "ge"
      ? ["Fallstudie", "Videoschnitt Ergebnisse", caseStudy.company, caseStudy.industry, "DON Video"]
      : ["case study", "video editing results", caseStudy.company, caseStudy.industry, "DON Video"],
...
export default async function CaseStudyPage({
  ...
  const caseStudyJsonLd = {
    ...
    "author": { "@type": "Organization", "name": "DON Video", "url": SITE_URL },
    "publisher": { "@type": "Organization", "name": "DON Video", "logo": { "@type": "ImageObject", "url": absoluteUrl("/og-image.jpg") } },
